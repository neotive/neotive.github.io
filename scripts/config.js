...
export const text = {
    ...
    footer_terms: resources.text_footer_terms,
    footer_terms_link: resources.text_footer_terms_link,
...
export const buttons = {
    ...
    bmc: new models.IconButton(
        resources.button_bmc_link,
        resources.button_bmc_icon
    ),
    ...
    appstore: new models.IconButton(
        resources.button_appstore_link,
        resources.button_appstore_icon,
        resources.button_appstore_size
    ),
